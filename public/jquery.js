...
setDocument = Sizzle.setDocument = function( node ) {
	...
	support.getByName = assert(function( div ) {
		...
		// Test
		const pass = doc.getElementsByName &&
...
jQuery.ajaxSetup({
	...
	jsonpCallback: function() {
		const callback = oldCallbacks.pop() || ( jQuery.expando + "_" + ( ajax_nonce++ ) );
		this[ callback ] = true;
		return callback;
	}
});
